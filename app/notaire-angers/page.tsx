...
export const metadata: Metadata = {
  title: "Notaire à Angers · Notaires.io",
  description:
    "Trouvez un notaire à Angers disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Angers",
  ...
  openGraph: {
    title: "Notaire à Angers · Notaires.io",
    description:
      "Trouvez un notaire à Angers disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Angers pour votre mariage, votre PACS, un achat immobilier en Anjou ou la création de votre société ? Nos notaires partenaires angevins sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
