...
export const metadata: Metadata = {
  title: "Notaire à Dijon · Notaires.io",
  description:
    "Trouvez un notaire à Dijon disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Dijon",
  ...
  openGraph: {
    title: "Notaire à Dijon · Notaires.io",
    description:
      "Trouvez un notaire à Dijon disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Dijon pour votre mariage, votre PACS, un achat immobilier en Bourgogne ou la création de votre société ? Nos notaires partenaires dijonnais sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
