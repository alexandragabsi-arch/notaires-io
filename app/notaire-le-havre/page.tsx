...
export const metadata: Metadata = {
  ...
  description:
    "Trouvez un notaire au Havre disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Le Havre",
  ...
  openGraph: {
    title: "Notaire au Havre · Notaires.io",
    description:
      "Trouvez un notaire au Havre disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire au Havre pour votre mariage, votre PACS, un achat immobilier en Seine-Maritime ou la création de votre société ? Nos notaires partenaires havrais sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
