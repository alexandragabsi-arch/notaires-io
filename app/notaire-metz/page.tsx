...
export const metadata: Metadata = {
  title: "Notaire à Metz · Notaires.io",
  description:
    "Trouvez un notaire à Metz disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Metz",
  ...
  openGraph: {
    title: "Notaire à Metz · Notaires.io",
    description:
      "Trouvez un notaire à Metz disponible rapidement, en visio ou au cabinet.",
...
export default function Page() {
  ...
  const scrapedNotaires = getNotairesByCity("Metz");
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Metz pour votre mariage, votre PACS, un achat immobilier en Moselle ou la création de votre société ? Nos notaires partenaires messins maîtrisent le droit local et sont disponibles sous 48 h, en visio ou au cabinet."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
