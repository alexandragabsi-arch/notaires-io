...
export const metadata: Metadata = {
  title: "Notaire à Montpellier · Notaires.io",
  description:
    "Trouvez un notaire à Montpellier disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Montpellier",
  ...
  openGraph: {
    title: "Notaire à Montpellier · Notaires.io",
    description:
      "Trouvez un notaire à Montpellier disponible rapidement, en visio ou au cabinet.",
...
export default function Page() {
  ...
  const scrapedNotaires = getNotairesByCity("Montpellier");
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Montpellier pour votre mariage, votre PACS, un achat immobilier ou la création de votre société ? Nos notaires partenaires montpelliérains sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
