...
export const metadata: Metadata = {
  title: "Notaire à Nancy · Notaires.io",
  description:
    "Trouvez un notaire à Nancy disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Nancy",
  ...
  openGraph: {
    title: "Notaire à Nancy · Notaires.io",
    description:
      "Trouvez un notaire à Nancy disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Nancy pour votre mariage, votre PACS, un achat immobilier en Lorraine ou la création de votre société ? Nos notaires partenaires nancéiens sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
