...
export const metadata: Metadata = {
  ...
  description:
    "Trouvez un notaire à Nice disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Nice",
  ...
  openGraph: {
    title: "Notaire à Nice · Notaires.io",
    description:
      "Trouvez un notaire à Nice disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Nice pour votre mariage, votre PACS, un achat immobilier sur la Côte d'Azur ou la création de votre société ? Nos notaires partenaires niçois sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
