...
export const metadata: Metadata = {
  title: "Notaire à Perpignan · Notaires.io",
  description:
    "Trouvez un notaire à Perpignan disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Perpignan",
  ...
  openGraph: {
    title: "Notaire à Perpignan · Notaires.io",
    description:
      "Trouvez un notaire à Perpignan disponible rapidement, en visio ou au cabinet.",
...
export default function Page() {
  ...
  const scrapedNotaires = getNotairesByCity("Perpignan");
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Perpignan pour votre mariage, votre PACS, un achat immobilier en Roussillon ou la création de votre société ? Nos notaires partenaires perpignanais sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
