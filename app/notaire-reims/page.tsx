...
export const metadata: Metadata = {
  title: "Notaire à Reims · Notaires.io",
  description:
    "Trouvez un notaire à Reims disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Reims",
  ...
  openGraph: {
    title: "Notaire à Reims · Notaires.io",
    description:
      "Trouvez un notaire à Reims disponible rapidement, en visio ou au cabinet.",
...
export default function Page() {
  ...
  const scrapedNotaires = getNotairesByCity("Reims");
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Reims pour votre mariage, votre PACS, un achat immobilier en Champagne ou la création de votre société ? Nos notaires partenaires rémois sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
