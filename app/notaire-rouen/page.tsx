...
export const metadata: Metadata = {
  ...
  description:
    "Trouvez un notaire à Rouen disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Rouen",
  ...
  openGraph: {
    title: "Notaire à Rouen · Notaires.io",
    description:
      "Trouvez un notaire à Rouen disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Rouen pour votre mariage, votre PACS, un achat immobilier en Normandie ou la création de votre société ? Nos notaires partenaires rouennais sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
