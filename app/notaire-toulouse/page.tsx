...
export const metadata: Metadata = {
  title: "Notaire à Toulouse · Notaires.io",
  description:
    "Trouvez un notaire à Toulouse disponible rapidement. Mariage, PACS, immobilier, création de société — prise de RDV en ligne. Notaires certifiés, tarifs réglementés.",
  keywords: [
    "notaire Toulouse",
  ...
  openGraph: {
    title: "Notaire à Toulouse · Notaires.io",
    description:
      "Trouvez un notaire à Toulouse disponible rapidement, en visio ou au cabinet.",
    ...
    <>
      ...
      <main>
        <SeoLandingPage
          ...
          intro="Vous cherchez un notaire à Toulouse pour votre mariage, votre PACS, un achat immobilier ou la création de votre société ? Nos notaires partenaires toulousains sont disponibles sous 48 h, en visio ou au cabinet dans votre quartier."
          notaires={notaires}
          faq={FAQ}
          relatedLinks={[
